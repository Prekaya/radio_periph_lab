...
entity radiocore is
  ...
  attribute CORE_GENERATION_INFO of radiocore : entity is "radiocore,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=radiocore,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=20,numReposBlks=20,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
...
architecture STRUCTURE of radiocore is
  ...
  component radiocore_util_vector_logic_0_0 is
  port (
    Op1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    Res : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component radiocore_util_vector_logic_0_0;
...
begin
  FIFO_COUNT(31 downto 0) <= axis_data_fifo_0_axis_wr_data_count(31 downto 0);
...
util_vector_logic_0: component radiocore_util_vector_logic_0_0
     port map (
      Op1(0) => aresetn_1,
